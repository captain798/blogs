...
- 数据结构 线性表（数组、队列、栈、链表），树（堆、排序二叉树）
哈希表，集合，图
- 算法与算法设计策略 排序与查找，枚举，贪心策略，分治策略，递推与递归
动态规划，搜索，图论算法，计算几何，字符串算法
随机算法，近似算法等
...
- 推荐哈工大苏小红的C语言程序设计，这本书相对来说比较高阶，会有涉及到链表操作，这对学习数据结构很有帮助
